 ...
 */
package example.bank.database.generated.keys
...
val ACCOUNT_TRANSACTION__ACCOUNT_TRANSACTION_BANK_ACCOUNT_ID_FKEY: ForeignKey<AccountTransactionRecord, BankAccountRecord> = Internal.createForeignKey(AccountTransaction.ACCOUNT_TRANSACTION, DSL.name("account_transaction_bank_account_id_fkey"), arrayOf(AccountTransaction.ACCOUNT_TRANSACTION.BANK_ACCOUNT_ID), example.bank.database.generated.keys.BANK_ACCOUNT_PKEY, arrayOf(BankAccount.BANK_ACCOUNT.ID), true)
val BANK_ACCOUNT__BANK_ACCOUNT_ACCOUNT_HOLDER_ID_FKEY: ForeignKey<BankAccountRecord, AccountHolderRecord> = Internal.createForeignKey(BankAccount.BANK_ACCOUNT, DSL.name("bank_account_account_holder_id_fkey"), arrayOf(BankAccount.BANK_ACCOUNT.ACCOUNT_HOLDER_ID), example.bank.database.generated.keys.ACCOUNT_HOLDER_PKEY, arrayOf(AccountHolder.ACCOUNT_HOLDER.ID), true)
