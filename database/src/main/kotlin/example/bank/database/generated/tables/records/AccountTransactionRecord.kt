...
open class AccountTransactionRecord() : UpdatableRecordImpl<AccountTransactionRecord>(AccountTransaction.ACCOUNT_TRANSACTION), Record4<Long?, Long?, BigDecimal?, TransactionType?> {
    ...
    override fun valuesRow(): Row4<Long?, Long?, BigDecimal?, TransactionType?> = super.valuesRow() as Row4<Long?, Long?, BigDecimal?, TransactionType?>
    ...
    override fun field4(): Field<TransactionType?> = AccountTransaction.ACCOUNT_TRANSACTION.TRANSACTION_TYPE
    override fun component1(): Long? = id
    override fun component2(): Long? = bankAccountId
    override fun component3(): BigDecimal? = amount
    override fun component4(): TransactionType? = transactionType
    override fun value1(): Long? = id
    override fun value2(): Long? = bankAccountId
    override fun value3(): BigDecimal? = amount
    override fun value4(): TransactionType? = transactionType
    ...
    override fun value4(value: TransactionType?): AccountTransactionRecord {
        this.transactionType = value
        return this
    }

    override fun values(value1: Long?, value2: Long?, value3: BigDecimal?, value4: TransactionType?): AccountTransactionRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, bankAccountId: Long? = null, amount: BigDecimal? = null, transactionType: TransactionType? = null): this() {
        this.id = id
